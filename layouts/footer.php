            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-center text-gray-600">
                        <i class="fa-regular fa-envelope w-5 h-5 mr-2 text-primary"></i>
                        support@monetra.com
                    </li>
                    <li class="flex items-center text-gray-600">
                        <i class="fa-solid fa-phone w-5 h-5 mr-2 text-primary"></i>
                        (123) 456-7890
                    </li>
                    <li class="flex items-center text-gray-600">
                        <i class="fa-solid fa-location-pin w-5 h-5 mr-2 text-primary"></i>
